...
declare let getDeviceInfo: {
    (options?: {
        enhance: true;
    } & import("./RokuDeploy").GetDeviceInfoOptions): Promise<import("./DeviceInfo").DeviceInfo>;
    (options?: import("./RokuDeploy").GetDeviceInfoOptions): Promise<import("./DeviceInfo").DeviceInfoRaw>;
};
