...
class Scope {
    ...
    getEnumMemberFileLink(enumMemberName, containingNamespace) {
        var _a;
        let lowerNameParts = enumMemberName === null || enumMemberName === void 0 ? void 0 : enumMemberName.split('.');
        let memberName = (_a = lowerNameParts === null || lowerNameParts === void 0 ? void 0 : lowerNameParts.splice(lowerNameParts.length - 1, 1)) === null || _a === void 0 ? void 0 : _a[0];
        ...
        if (enumeration) {
            let member = enumeration.item.findChild((child) => (0, reflection_1.isEnumMemberStatement)(child) && child.name === memberName);
