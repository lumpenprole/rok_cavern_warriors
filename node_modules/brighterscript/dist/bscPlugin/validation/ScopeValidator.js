    ...
    iterateFileExpressions(file) {
        ...
        outer: for (const info of expressionInfos) {
            ...
            if (scope.namespaceLookup.has(entityNameLower)) {
                this.addMultiScopeDiagnostic(Object.assign(Object.assign({}, DiagnosticMessages_1.DiagnosticMessages.namespaceCannotBeReferencedDirectly()), { range: info.expression.range, file: file }), 'When used in scope');
            }
        }
    }
    /**
