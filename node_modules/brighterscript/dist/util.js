...
class Util {
    ...
    normalizeConfig(config) {
        ...
        config.diagnosticFilters = (_g = config.diagnosticFilters) !== null && _g !== void 0 ? _g : [];
        config.plugins = (_h = config.plugins) !== null && _h !== void 0 ? _h : [];
        ...
        config.logLevel = (_j = config.logLevel) !== null && _j !== void 0 ? _j : Logger_1.LogLevel.log;
        return config;
    }
    /**
